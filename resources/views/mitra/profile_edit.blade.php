                ...
                <section class="rounded-3xl bg-white p-6 shadow-sm">
                    ...
                    <div class="space-y-5">
                        <div>
                            ...
                            <input type="text" name="nama" value="{{ old('nama', data_get($profile, 'nama', '')) }}" placeholder="Isi nama panjang" class="w-full rounded-xl border border-slate-200 bg-slate-100 px-4 py-3 focus:border-[#006b9b] focus:outline-none focus:ring-2 focus:ring-[#b3dff2]" required>
                        ...
                        <div>
                            ...
                            <input type="text" name="phone" value="{{ old('phone', data_get($profile, 'phone', '')) }}" placeholder="Isi nomor HP" class="w-full rounded-xl border border-slate-200 bg-slate-100 px-4 py-3 focus:border-[#006b9b] focus:outline-none focus:ring-2 focus:ring-[#b3dff2]">
                            @error('phone') <p class="mt-1 text-xs text-rose-600">{{ $message }}</p> @enderror
                        </div>

                        <div>
                            <label class="mb-2 block text-sm font-semibold text-slate-600">Deskripsi Diri</label>
                            <textarea name="bio" rows="3" placeholder="Isi deskripsi diri" class="w-full rounded-xl border border-slate-200 bg-slate-100 px-4 py-3 focus:border-[#006b9b] focus:outline-none focus:ring-2 focus:ring-[#b3dff2]">{{ old('bio', data_get($profile, 'bio', '')) }}</textarea>
                        ...
                        <div>
                            ...
                            <input type="text" name="location" value="{{ old('location', data_get($profile, 'location', '')) }}" placeholder="Contoh: Bandung, Cimahi" class="w-full rounded-xl border border-slate-200 bg-slate-100 px-4 py-3 focus:border-[#006b9b] focus:outline-none focus:ring-2 focus:ring-[#b3dff2]">
                ...
                <section class="rounded-3xl bg-white p-6 shadow-sm">
                    ...
                    <div class="space-y-5">
                        <div>
                            ...
                            <input type="text" name="nama_bank" value="{{ old('nama_bank', data_get($bankAccount, 'nama_bank', '')) }}" placeholder="Contoh: BCA" class="w-full rounded-xl border border-slate-200 bg-slate-100 px-4 py-3 focus:border-[#006b9b] focus:outline-none focus:ring-2 focus:ring-[#b3dff2]">
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_rekening" value="{{ old('nama_rekening', data_get($bankAccount, 'nama_rekening', '')) }}" placeholder="Isi Nama Rekening" class="w-full rounded-xl border border-slate-200 bg-slate-100 px-4 py-3 focus:border-[#006b9b] focus:outline-none focus:ring-2 focus:ring-[#b3dff2]">
                        ...
                        <div>
                            ...
                            <input type="text" name="nomor_rekening" value="{{ old('nomor_rekening', data_get($bankAccount, 'nomor_rekening', '')) }}" placeholder="Isi Nomor Rekening" class="w-full rounded-xl border border-slate-200 bg-slate-100 px-4 py-3 focus:border-[#006b9b] focus:outline-none focus:ring-2 focus:ring-[#b3dff2]">
                        ...
                        <div>
                            ...
                            <input type="text" name="alamat_bank" value="{{ old('alamat_bank', data_get($bankAccount, 'alamat_bank', '')) }}" placeholder="Isi alamat bank" class="w-full rounded-xl border border-slate-200 bg-slate-100 px-4 py-3 focus:border-[#006b9b] focus:outline-none focus:ring-2 focus:ring-[#b3dff2]">
                ...
                <section class="rounded-3xl bg-white p-6 shadow-sm">
                    ...
                    <div class="mb-4 flex justify-center">
                        <div class="h-36 w-36 overflow-hidden rounded-2xl border border-slate-200 bg-slate-100">
                            ...
                            @else
                                <div class="flex h-full items-center justify-center text-4xl font-bold text-slate-400">{{ strtoupper(substr(data_get($profile, 'nama', 'U'), 0, 1)) }}</div>
                            @endif
                        </div>
                    </div>
